...
const validateForm = () => {
  ...
  if (form.password !== form.confirmPassword) {
    confirmPasswordError.value = 'Password dan konfirmasi password tidak cocok'
    return false
  }

  if (!form.agreeTerms) {
    termsError.value = 'Anda harus menyetujui syarat dan ketentuan'
    return false
  }
    ...
    <div class="relative w-full max-w-md">
      ...
      <Card class="backdrop-blur-sm border-0 shadow-2xl shadow-blue-500/10">
        <CardHeader class="space-y-2 text-center pb-6">
          <CardTitle class="text-2xl font-bold text-gray-900">Daftar Akun Baru</CardTitle>
        ...
        <CardContent class="space-y-6">
          ...
          <form @submit.prevent="handleSubmit" class="space-y-5">
            ...
            <p v-if="termsError" class="text-sm text-red-600 flex items-center gap-1">
              <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path
                  stroke-linecap="round"
                  stroke-linejoin="round"
          ...
          <div class="relative my-6 flex items-center justify-between">
            ...
            <div class="relative flex justify-center text-sm w-full">
              <span class="px-4 text-gray-500 font-medium">Atau daftar dengan</span>
            </div>
            <div class="w-60 border-t border-gray-300"></div>
          </div>
